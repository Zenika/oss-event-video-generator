...
export const hacktoberfestOctober10Agences: z.infer<typeof EventSchema> = {
	...
	eventDescription: 'L’agence de Zenika Lyon invite Pierre-Yves Gosset, codirecteur de Framasoft, pour vous proposer un REX sur ces vingts années d\'aventure dans le monde de l\'Open source 💪. L\'évènement sera également disponible sur les chaînes Youtube et Twitch de Zenika.',
